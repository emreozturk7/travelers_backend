...
namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string UserNotRegistered = "Kullanıcı başarıyla kaydedilemedi.";
        ...
        public static string FavoriteAdded = "Favorilere başarıyla eklendi.";
        public static string FavoriteUpdate = "Favoriler başarıyla güncellendi.";

        public static string ImageAdded = "Fotoğraf eklendi.";

        public static string PasswordValid = "Kayıt başarılı bir şekilde oluşturuldu.";
        public static string PasswordINvalid = "Parola veya E-mail uygun değil.";
    }
}
